...
public class SendEffect {
   ...
   public void send_danh_hieu(Player player, int iddanhhieu, int ngày) {
      Service.getInstance().sendThongBao(player,
            "Bạn nhận được danh hiệu " + Name_Danh_Hieu(iddanhhieu) + " " + ngày + " ngày");
      ...
      if (player.IdDanhHieu_1 == iddanhhieu) { // 1_1
         ...
         Service.getInstance().point(player);
         removeTitle(player);
      } else if (player.lastTimeTitle1 != 0 && player.lastTimeTitle2 == 0 && player.IdDanhHieu_1 != iddanhhieu
         ...
         removeTitle(player);
            ...
            && player.IdDanhHieu_1 != iddanhhieu && player.IdDanhHieu_2 != iddanhhieu
         ...
         removeTitle(player);
            ...
            && player.lastTimeTitle4 == 0 && player.IdDanhHieu_1 != iddanhhieu && player.IdDanhHieu_2 != iddanhhieu
            && player.IdDanhHieu_3 != iddanhhieu && player.IdDanhHieu_4 != iddanhhieu) {
         ...
         removeTitle(player);
            ...
            && player.lastTimeTitle4 != 0 && player.lastTimeTitle5 == 0 && player.IdDanhHieu_1 != iddanhhieu
            && player.IdDanhHieu_2 != iddanhhieu && player.IdDanhHieu_3 != iddanhhieu
            && player.IdDanhHieu_4 != iddanhhieu && player.IdDanhHieu_5 != iddanhhieu) {
