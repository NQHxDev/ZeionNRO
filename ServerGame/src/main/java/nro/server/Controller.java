...
public class Controller {
    ...
    private static final String CLIENT_SHARED_SECRET = "NRO_SERVERGAME_NEW_14_1_2026";// Helper: hex -> bytes
    ...
    public void messageNotLogin(Session session, Message msg) {
        if (msg != null) {
            try {
                ...
                //                     "Phiên bản không hợp lệ. Vui lòng phiên bản mới tại trang chủ nroservergame.online");
                //             session.disconnect();
                //         } else {
