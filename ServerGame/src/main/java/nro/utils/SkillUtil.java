...
//        return 10000;
    ...
    public static int getTimeBienHinhSc(boolean lastLevel, int coolDown) { //thời gian biến hình siêu cấp
        int per = lastLevel ? 400 : 500;
        return coolDown * per / 100;
    }

    public static int getTimeHoiBienHinhSc(int coolDown) { //thời gian biến hình siêu cấp
        return coolDown = 50;
    }

    public static int getPercentHPBienHinhSc(int level) { //tỉ lệ máu huýt sáo cộng thêm v
        return (level + 1) * 6;
    }

    public static int getPercentMPBienHinhSc(int level) { //tỉ lệ máu huýt sáo cộng thêm v
        return (level + 1) * 7;
    }

    public static int getPercentDameBienHinhSc(int level) { //tỉ lệ máu huýt sáo cộng thêm v
        return (level + 1) * 5;
    }
...
//        }
    ...
    public static byte getTempSkillSkillByItemID(int id) {
        ...
        } else if (id >= 1823 && id <= 1827) {
            return Skill.BIEN_HINH_TD;
        } else if (id >= 1828 && id <= 1832) {
            return Skill.BIEN_HINH_XD;
        } else if (id >= 1833 && id <= 1837) {
            return Skill.BIEN_HINH_NM;
        } else if (id >= 1838 && id <= 1844) {
    ...
    public static Skill getSkillByItemID(Player pl, int tempId) {
        ...
        } else if (tempId >= 1823 && tempId <= 1827) {
            return getSkillbyId(pl, Skill.BIEN_HINH_TD);
        } else if (tempId >= 1828 && tempId <= 1832) {
            return getSkillbyId(pl, Skill.BIEN_HINH_XD);
        } else if (tempId >= 1833 && tempId <= 1837) {
            return getSkillbyId(pl, Skill.BIEN_HINH_NM);
        } else if (tempId >= 1838 && tempId <= 1844) {
    ...
    public static Skill getSkillByLevel(int tempId, byte level) {
        if (tempId >= 66 && tempId <= 72) {
            ...
            return getSkill(Skill.BIEN_HINH_TD, level);
        } else if (tempId >= 1828 && tempId <= 1832) {
            return getSkill(Skill.BIEN_HINH_XD, level);
        } else if (tempId >= 1833 && tempId <= 1837) {
            return getSkill(Skill.BIEN_HINH_NM, level);
        } else if (tempId >= 1838 && tempId <= 1844) {
