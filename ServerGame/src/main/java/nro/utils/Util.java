...
public class Util {
   ...
   public static String formatBigDame(double value) {
      String[] suffixes = { "", " Triệu", " Tỷ", " Ngàn Tỷ", " Triệu Tỉ", " Tỉ Tỉ", " Ngàn Tỉ Tỉ", " Triệu Tỉ Tỉ",
            " Tỉ Tỉ Tỉ", " VIP", " VIP+" };
      int index = 0;
   ...
   public static Item ratiItemTL(int tempId) {
      ...
      if (ao.contains(tempId)) {
         it.itemOptions
               .add(new ItemOption(47, highlightsItem(it.template.gender == 2, new Random().nextInt(501) + 1000)));
      }
      ...
      if (gang.contains(tempId)) {
         it.itemOptions
               .add(new ItemOption(0, highlightsItem(it.template.gender == 2, new Random().nextInt(1001) + 3500)));
      }
   ...
   public static Item ratiItemHuyDiet(int tempId) {
      ...
      if (ao.contains(tempId)) {
         it.itemOptions.add(
               new ItemOption(47, Util.highlightsItem(it.template.gender == 2, new Random().nextInt(1001) + 1800))); // áo
                                                                                                                     // từ
                                                                                                                     // 1800-2800
                                                                                                                     // giáp
      }
      if (quan.contains(tempId)) {
         it.itemOptions
               .add(new ItemOption(22, Util.highlightsItem(it.template.gender == 0, new Random().nextInt(16) + 85))); // hp
                                                                                                                      // 85-100k
      }
      if (gang.contains(tempId)) {
         it.itemOptions
               .add(new ItemOption(0, Util.highlightsItem(it.template.gender == 2, new Random().nextInt(1500) + 8500))); // 8500-10000
      }
      if (giay.contains(tempId)) {
         it.itemOptions
               .add(new ItemOption(23, Util.highlightsItem(it.template.gender == 1, new Random().nextInt(11) + 80))); // ki
                                                                                                                      // 80-90k
      }
      if (nhd == tempId) {
   ...
   public static Item ratiItemThienSu(int tempId) {
      ...
      if (ao.contains(tempId)) {
         it.itemOptions.add(
               new ItemOption(47, Util.highlightsItem(it.template.gender == 2, new Random().nextInt(2001) + 3000))); // áo
                                                                                                                     // từ
                                                                                                                     // 1800-2800
                                                                                                                     // giáp
      ...
      if (quan.contains(tempId)) {
         it.itemOptions
               .add(new ItemOption(22, Util.highlightsItem(it.template.gender == 0, new Random().nextInt(234) + 345))); // hp
                                                                                                                        // 85-100k
         if (Util.isTrue(50, 100)) {
      ...
      if (gang.contains(tempId)) {
         it.itemOptions.add(
               new ItemOption(0, Util.highlightsItem(it.template.gender == 2, new Random().nextInt(6789) + 14444))); // 8500-10000
         if (Util.isTrue(50, 100)) {
      ...
      if (giay.contains(tempId)) {
         it.itemOptions
               .add(new ItemOption(23, Util.highlightsItem(it.template.gender == 1, new Random().nextInt(234) + 345))); // ki
                                                                                                                        // 80-90k
         if (Util.isTrue(50, 100)) {
   ...
   public static Item ratiItemThanhTon(int tempId) {
      ...
      if (ao == tempId) {
         it.itemOptions
               .add(new ItemOption(47, highlightsItem(it.template.gender == 2, new Random().nextInt(30000) + 20000)));
      ...
      if (quan == tempId) {
         it.itemOptions
               .add(new ItemOption(22, highlightsItem(it.template.gender == 0, new Random().nextInt(400) + 600)));
         if (Util.isTrue(30, 100)) {
      ...
      if (gang == tempId) {
         it.itemOptions
               .add(new ItemOption(0, highlightsItem(it.template.gender == 2, new Random().nextInt(15000) + 30000)));
         if (Util.isTrue(30, 100)) {
      ...
      if (giay == tempId) {
         it.itemOptions
               .add(new ItemOption(23, highlightsItem(it.template.gender == 1, new Random().nextInt(400) + 600)));
         if (Util.isTrue(30, 100)) {
   ...
   public static Item ratiItemThanhTonVIP(int tempId) {
      ...
      if (ao == tempId) {
         it.itemOptions
               .add(new ItemOption(47, highlightsItem(it.template.gender == 2, new Random().nextInt(300000) + 200000)));
         it.itemOptions.add(new ItemOption(108, Util.nextInt(5, 20)));
      }
      if (quan == tempId) {
         it.itemOptions
               .add(new ItemOption(22, highlightsItem(it.template.gender == 0, new Random().nextInt(4000) + 6000)));
         it.itemOptions.add(new ItemOption(77, Util.nextInt(20, 40)));
      }
      if (gang == tempId) {
         it.itemOptions
               .add(new ItemOption(0, highlightsItem(it.template.gender == 2, new Random().nextInt(150000) + 300000)));
         it.itemOptions.add(new ItemOption(50, Util.nextInt(10, 20)));
      }
      if (giay == tempId) {
         it.itemOptions
               .add(new ItemOption(23, highlightsItem(it.template.gender == 1, new Random().nextInt(4000) + 6000)));
