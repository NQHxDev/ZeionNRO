...
public class Trade {
      ...
      switch (item.template.type) {
         case 27: //
            if (item.template.id != 457 // && item.template.id == 590
                  && item.template.id == 2013 && item.template.id == 2014 && item.template.id == 699
                  && item.template.id == 700 && item.template.id == 701
   ...
   private void startTrade() {
      ...
      // if (goldTrade1 > 0 && (player1.MaxGoldTradeDay > 2000000000 ||
      // player2.MaxGoldTradeDay > 2000000000)) {
      // tradeStatus = FAIL_2TY_GOLD_PLAYER1;
      // } else if (goldTrade2 > 0 && (player1.MaxGoldTradeDay > 2000000000 ||
      // player2.MaxGoldTradeDay > 2000000000)) {
   ...
   private void sendNotifyTrade(byte status) {
      switch (status) {
         ...
         case FAIL_NOT_ENOUGH_BAG_P1:
            ...
            Service.getInstance().sendThongBao(player2,
                  "Giao dịch thất bại do " + player1.name + " không đủ chỗ ô hành trang");
            break;
         case FAIL_NOT_ENOUGH_BAG_P2:
            Service.getInstance().sendThongBao(player2, "Giao dịch thất bại do không đủ ô trống hành trang");
            Service.getInstance().sendThongBao(player1,
                  "Giao dịch thất bại do " + player2.name + " không đủ chỗ ô hành trang");
            break;
         case FAIL_2TY_GOLD_PLAYER1:
            ...
            Service.getInstance().sendThongBao(player2,
                  "Giao dịch thất bại do số lượng vàng " + player1.name + " sau giao dịch vượt quá 2 Tỷ");
            break;
         case FAIL_2TY_GOLD_PLAYER2:
            ...
            Service.getInstance().sendThongBao(player1,
                  "Giao dịch thất bại do số lượng vàng " + player2.name + " sau giao dịch vượt quá 2 Tỷ");
            break;
         case FAIL_GOLD_MAX1:
            Service.getInstance().sendThongBao(player1, "Giao dịch thất bại do số lượng vàng giao dịch quá 100tr");
            Service.getInstance().sendThongBao(player2,
                  "Giao dịch thất bại do số lượng vàng " + player1.name + " giao dịch quá 100tr");
            break;
         case FAIL_GOLD_MAX2:
            Service.getInstance().sendThongBao(player2, "Giao dịch thất bại do số lượng vàng giao dịch quá 100tr");
            Service.getInstance().sendThongBao(player1,
                  "Giao dịch thất bại do số lượng vàng " + player2.name + " giao dịch quá 100tr");
            break;
      }
   }
