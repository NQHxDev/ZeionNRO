      ...
      if (TaskService.gI().isCurrentTask(player, idTaskCustom)) {
         ...
         switch (idTaskCustom) {
            ...
            case ConstTask.TASK_2_1:
               InventoryService.gI().subQuantityItemsBag(player, InventoryService.gI().findItemBagByTemp(player, 73),
                     10);
            ...
            case ConstTask.TASK_3_2:
               InventoryService.gI().subQuantityItemsBag(player, InventoryService.gI().findItemBagByTemp(player, 78),
                     1);
               InventoryService.gI().sendItemBags(player);
               Service.getInstance().sendFlagBag(player);
               npcSay(player, ConstTask.NPC_NHA,
