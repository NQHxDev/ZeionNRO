      ...
      try {
         while (true) {
            ...
            if ((this.lastTimeThongBao - System.currentTimeMillis()) / 1000 <= 0) {
               thongbao(
                     "Đây là minigame tranh tài ai chiến thắng, vật phẩm trong trò chơi đều là ảo, KHÔNG tổ chức buôn bán trái phép. Admin chúc mọi người chơi game vui vẻ !");// thông
                                                                                                                                                                               // báo
                                                                                                                                                                               // chạy
                                                                                                                                                                               // phía
                                                                                                                                                                               // dưới
                  ...
                  if (!this.PlayersTai.isEmpty()) {
                     for (int i = 0; i < this.PlayersTai.size(); i++) {
                        ...
                        if (pl != null && Client.gI().getPlayer(pl.name) != null) {
                           ...
                           Service.getInstance().sendThongBaoOK(pl, "Chúc mừng bạn đã dành chiến thắng và nhận được "
