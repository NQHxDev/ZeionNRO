...
public class MobService {
   ...
   public boolean isMonterFly(int tempId) {
      return tempId == ConstMob.THAN_LAN_BAY || tempId == ConstMob.PHI_LONG || tempId == ConstMob.QUY_BAY
            || tempId == ConstMob.THAN_LAN_ME || tempId == ConstMob.PHI_LONG_ME
            || tempId == ConstMob.QUY_BAY_ME || tempId == ConstMob.ALIEN || tempId == ConstMob.TAMBOURINE
            || tempId == ConstMob.THAN_LAN_BAY_2
            || tempId == ConstMob.PHI_LONG_2 || tempId == ConstMob.QUY_BAY_2 || tempId == ConstMob.KHONG_TAC
            || tempId == ConstMob.QUY_DAU_TO
            || tempId == ConstMob.QUY_DIA_NGUC || tempId == ConstMob.ROBOT_BAY || tempId == ConstMob.THAN_LAN_XANH
            || tempId == ConstMob.DOI_DA_XANH
            || tempId == ConstMob.QUY_CHIM || tempId == ConstMob.DA_XANH || tempId == ConstMob.ARBEE
            || tempId == ConstMob.TABURINE_DO || tempId == ConstMob.PHU_THUY;
   }
}
