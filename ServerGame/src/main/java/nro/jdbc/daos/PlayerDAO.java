         ...
         if (player.loaded) {
            ...
            try {
               ...
               dataItemTime.add(player.itemTime.isUseAnDanh
                     ...
                     : 0);
               dataItemTime.add(player.itemTime.isOpenPower
               ...
               JSONArray dataItemTimeSC = new JSONArray();
               dataItemTimeSC
                     .add((player.itemTimesieucap.isDuoikhi
                           ? (ItemTimeSieuCap.TIME_ITEM_SC_10P
                                 - (System.currentTimeMillis() - player.itemTimesieucap.lastTimeDuoikhi))
                           : 0));
               dataItemTimeSC
                     .add((player.itemTimesieucap.isDaNgucTu
                           ? (ItemTimeSieuCap.TIME_ITEM_SC_10P
                                 - (System.currentTimeMillis() - player.itemTimesieucap.lastTimeDaNgucTu))
                           : 0));
               dataItemTimeSC
                     .add((player.itemTimesieucap.isUseCaRot
                           ? (ItemTimeSieuCap.TIME_ITEM_SC_10P
                                 - (System.currentTimeMillis() - player.itemTimesieucap.lastTimeCaRot))
                           : 0));
               dataItemTimeSC
                     .add((player.itemTimesieucap.isKeo
                           ? (ItemTimeSieuCap.TIME_ITEM_SC_30P
                                 - (System.currentTimeMillis() - player.itemTimesieucap.lastTimeKeo))
                           : 0));
               dataItemTimeSC
                     .add((player.itemTimesieucap.isUseXiMuoi
                           ? (ItemTimeSieuCap.TIME_ITEM_SC_10P
                                 - (System.currentTimeMillis() - player.itemTimesieucap.lastTimeUseXiMuoi))
                           : 0));
               dataItemTimeSC.add(player.itemTimesieucap.iconBanh);
               dataItemTimeSC
                     .add((player.itemTimesieucap.isUseTrungThu
                           ? (ItemTimeSieuCap.TIME_TRUNGTHU
                                 - (System.currentTimeMillis() - player.itemTimesieucap.lastTimeUseBanh))
                           : 0));
               dataItemTimeSC
                     .add((player.itemTimesieucap.isChoido
                           ? (ItemTimeSieuCap.TIME_ITEM_SC_10P
                                 - (System.currentTimeMillis() - player.itemTimesieucap.lasttimeChoido))
                           : 0));
               dataItemTimeSC
                     .add((player.itemTimesieucap.isRongSieuCap
                           ? (ItemTimeSieuCap.TIME_ITEM_SC_30P
                                 - (System.currentTimeMillis() - player.itemTimesieucap.lastTimeRongSieuCap))
                           : 0));
               dataItemTimeSC
                     .add((player.itemTimesieucap.isRongBang
                           ? (ItemTimeSieuCap.TIME_ITEM_SC_30P
                                 - (System.currentTimeMillis() - player.itemTimesieucap.lastTimeRongBang))
                           : 0));
               dataItemTimeSC
                     .add((player.itemTimesieucap.isEatMeal
                           ? (ItemTimeSieuCap.TIME_ITEM_SC_10P
                                 - (System.currentTimeMillis() - player.itemTimesieucap.lastTimeMeal))
                           : 0));
               dataItemTimeSC.add(player.itemTimesieucap.iconMeal);
               dataItemTimeSC
                     .add((player.itemTimesieucap.isBienhinhSc
                           ? (ItemTimeSieuCap.TIME_ITEM_SC_10P
                                 - (System.currentTimeMillis() - player.itemTimesieucap.lastTimeBienhinhSc))
                           : 0));
               ...
               dataSieuHang
                     .add(player.rankSieuHang == 0 ? (player.rankSieuHang = (int) player.id) : player.rankSieuHang);
