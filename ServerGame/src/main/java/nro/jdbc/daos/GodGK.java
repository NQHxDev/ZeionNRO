      ...
      try {
         ...
         try {
            if (rs.next()) {
               ...
               player.itemTimesieucap.lastTimeDuoikhi = System.currentTimeMillis()
                     - (ItemTimeSieuCap.TIME_ITEM_SC_10P - timeDuoiKhi);
               player.itemTimesieucap.lastTimeDaNgucTu = System.currentTimeMillis()
                     - (ItemTimeSieuCap.TIME_ITEM_SC_10P - timeDaNgucTu);
               player.itemTimesieucap.lastTimeCaRot = System.currentTimeMillis()
                     - (ItemTimeSieuCap.TIME_ITEM_SC_10P - timeCaRot);
               player.itemTimesieucap.lastTimeKeo = System.currentTimeMillis()
                     - (ItemTimeSieuCap.TIME_ITEM_SC_30P - timeKeo);
               player.itemTimesieucap.lastTimeUseXiMuoi = System.currentTimeMillis()
                     - (ItemTimeSieuCap.TIME_ITEM_SC_10P - timeXiMuoi);
               player.itemTimesieucap.lastTimeUseBanh = System.currentTimeMillis()
                     - (ItemTimeSieuCap.TIME_TRUNGTHU - timeBanh);
               player.itemTimesieucap.lasttimeChoido = System.currentTimeMillis()
                     - (ItemTimeSieuCap.TIME_ITEM_SC_10P - timeChoido);
               player.itemTimesieucap.lastTimeRongSieuCap = System.currentTimeMillis()
                     - (ItemTimeSieuCap.TIME_ITEM_SC_30P - timeRongSieuCap);
               player.itemTimesieucap.lastTimeRongBang = System.currentTimeMillis()
                     - (ItemTimeSieuCap.TIME_ITEM_SC_30P - timeRongBang);
               player.itemTimesieucap.lastTimeMeal = System.currentTimeMillis()
                     - (ItemTimeSieuCap.TIME_ITEM_SC_10P - timeDuoi3);
