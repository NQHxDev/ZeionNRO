...
public class Thong_Che_Kilo extends Boss {

   public Thong_Che_Kilo() {
      super(BossFactory.THONG_CHE_KILO, BossData.THONG_CHE_KILO);
   }
   ...
   public void leaveMap() {
      BossFactory.createBoss(BossFactory.THONG_CHE_KILO).setJustRest();
      super.leaveMap();
