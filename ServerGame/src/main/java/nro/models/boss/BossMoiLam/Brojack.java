...
public class Brojack extends Boss {

   public Brojack() {
      super(BossFactory.BROJACK, BossData.BROJACK);
   }
   ...
   public void rewards(Player pl) {
      super.tileRoiCT_SuPhu_RandomChiSo(pl, 427, 5, 20, 30, 20, 30, 10, 50, 1, 2);
   ...
   public void leaveMap() {
      BossFactory.createBoss(BossFactory.BROJACK).setJustRest();
      super.leaveMap();
