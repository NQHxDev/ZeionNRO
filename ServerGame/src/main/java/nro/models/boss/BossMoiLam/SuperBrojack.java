...
public class SuperBrojack extends Boss {

   public SuperBrojack() {
      super(BossFactory.SUPER_BROJACK, BossData.SUPER_BROJACK);
   }
   ...
   public void rewards(Player pl) {
      super.tileRoiCT_SuPhu_RandomChiSo(pl, 428, 5, 20, 30, 20, 30, 10, 50, 1, 2);
   ...
   public void leaveMap() {
      BossFactory.createBoss(BossFactory.SUPER_BROJACK).setJustRest();
      super.leaveMap();
