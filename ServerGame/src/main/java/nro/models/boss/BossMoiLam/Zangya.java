...
public class Zangya extends Boss {
   ...
   public Zangya() {
      super(BossFactory.ZANGUYA, BossData.ZANGYA);
   }
   ...
   public void rewards(Player pl) {
      super.tileRoiCT_SuPhu_RandomChiSo(pl, 425, 5, 20, 30, 20, 30, 10, 50, 1, 2);
   ...
   public void leaveMap() {
      BossFactory.createBoss(BossFactory.ZANGUYA).setJustRest();
      super.leaveMap();
