...
public class KhungLong4 extends Boss {

   public KhungLong4() {
      super(BossFactory.KHUNG_LONG, BossData.KHUNG_LONG_4SAO);
   }
   ...
   public void rewards(Player pl) {
      super.DoXungQuanh(pl, 17, Util.nextInt(1, 10), 1);
   ...
   public void leaveMap() {
      ...
      BossFactory.createBoss(BossFactory.KHUNG_LONG4).setJustRest();
   }
}
