...
public class KhungLong6 extends Boss {

   public KhungLong6() {
      super(BossFactory.KHUNG_LONG, BossData.KHUNG_LONG_6SAO);
   }
   ...
   public void rewards(Player pl) {
      super.DoXungQuanh(pl, 19, Util.nextInt(10, 20), 1);
   ...
   public void leaveMap() {
      ...
      BossFactory.createBoss(BossFactory.KHUNG_LONG6).setJustRest();
   }
}
