...
public class KhungLong3 extends Boss {

   public KhungLong3() {
      super(BossFactory.KHUNG_LONG, BossData.KHUNG_LONG_3SAO);
   }
   ...
   public void rewards(Player pl) {
      super.DoXungQuanh(pl, 16, Util.nextInt(1, 5), 1);
   ...
   public void leaveMap() {
      ...
      BossFactory.createBoss(BossFactory.KHUNG_LONG3).setJustRest();
   }
}
