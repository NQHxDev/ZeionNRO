...
public class KhungLong2 extends Boss {

   public KhungLong2() {
      super(BossFactory.KHUNG_LONG, BossData.KHUNG_LONG_1SAO);
   }
   ...
   public void rewards(Player pl) {
      super.DoXungQuanh(pl, 15, Util.nextInt(1, 2), 1);
   ...
   public void leaveMap() {
      ...
      BossFactory.createBoss(BossFactory.KHUNG_LONG2).setJustRest();
   }
}
