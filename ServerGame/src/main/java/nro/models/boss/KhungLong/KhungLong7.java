...
public class KhungLong7 extends Boss {

   public KhungLong7() {
      super(BossFactory.KHUNG_LONG, BossData.KHUNG_LONG_7SAO);
   }
   ...
   public void rewards(Player pl) {
      super.DoXungQuanh(pl, 20, Util.nextInt(10, 30), 1);
   ...
   public void leaveMap() {
      ...
      BossFactory.createBoss(BossFactory.KHUNG_LONG7).setJustRest();
   }
}
