...
public class KhungLong5 extends Boss {

   public KhungLong5() {
      super(BossFactory.KHUNG_LONG, BossData.KHUNG_LONG_5SAO);
   }
   ...
   public void rewards(Player pl) {
      super.DoXungQuanh(pl, 18, Util.nextInt(5, 20), 1);
   ...
   public void leaveMap() {
      ...
      BossFactory.createBoss(BossFactory.KHUNG_LONG5).setJustRest();
   }
}
