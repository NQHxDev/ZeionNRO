...
public class TienHacAm extends Boss {

   public TienHacAm() {
      super(BossFactory.TIEN_HAC_AM, BossData.TIEN_HAC_AM);
   }
   ...
   public void rewards(Player pl) {
      super.DoXungQuanh(pl, 457, Util.nextInt(100, 500), 1);// 10- 1500 thỏi vàng
      super.tileRoiGangNhanThienSu(pl, 5, 5, 5);
      super.tileRoiQuanAoThienSu(pl, 10, 5, 5);
      super.itemDropCoTile1000(pl, 1539, 1, 1);
   ...
   public void leaveMap() {
      BossFactory.createBoss(BossFactory.TIEN_HAC_AM).setJustRest();
      super.leaveMap();
