...
public class Kaido extends Boss {
   ...
   public void rewards(Player pl) {
      super.DoXungQuanh(pl, 457, Util.nextInt(500, 1000), 1);
      super.tileRoiGangNhanThienSu(pl, 15, 5, 5);
      super.tileRoiQuanAoThienSu(pl, 20, 5, 5);
      super.itemDropCoTile(pl, 1537, 1, 1);
