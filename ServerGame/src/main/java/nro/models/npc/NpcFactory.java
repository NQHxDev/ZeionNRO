   ...
   public static Npc createNPC(int mapId, int status, int cx, int cy, int tempId, int avartar) {
      ...
      try {
         switch (tempId) {
               ...
               npc = new Npc(mapId, status, cx, cy, tempId, avartar) {
                  ...
                  public void openBaseMenu(Player player) {
                     if (player.iDMark.getTranhNgoc() == 1) {
                        this.createOtherMenu(player, ConstNpc.BASE_MENU, "Cút!Ta không nói chuyện với sinh vật hạ đẳng",
                              "Đóng");
                        return;
                     }
                        ...
                        switch (player.iDMark.getIndexMenu()) {
                           case ConstNpc.BASE_MENU:
                              switch (select) {
                                 ...
                                 // "Ngọc rồng Namếc đang bị 2 thế lực tranh giành\nHãy chọn cấp độ tham gia tùy
                                 // theo sức mạnh bản thân\nPhe Cadic: " +
                                 // TranhNgoc.gI().getPlayersCadic().size() + "\nPhe Fide: " +
                                 // TranhNgoc.gI().getPlayersFide().size(),
                                 ...
                                 // return;
                                 // }
                                 // Service.getInstance().sendPopUpMultiLine(player, 0, 7184, "Sự kiện sẽ mở đăng
                                 // ký vào lúc " + TranhNgoc.HOUR_REGISTER + ":" + TranhNgoc.MIN_REGISTER + "\nSự
                                 // kiện sẽ bắt đầu vào " + TranhNgoc.HOUR_OPEN + ":" + TranhNgoc.MIN_OPEN + " và
                                 // kết thúc vào " + TranhNgoc.HOUR_CLOSE + ":" + TranhNgoc.MIN_CLOSE);
                                 // break;
                                 // case 1:// Shop
                        ...
                        if (player.iDMark.isBaseMenu()) {
                           switch (select) {
                              ...
                              case 1: // shop
                                 ...
                                 return;
                              // if (player.gender == 0) {
                              // this.createOtherMenu(player, ConstNpc.HOC_SKILL_10_TD, "|8| Skill Gồng Cơ Đít
                              // Hít Cơ Mông\n\n"
                              // + "|7|Chú ý chọn dúng cấp độ cần học"
                              // + "\n Cố ý chọn sai bị trừ tiền ngu ráng chịu"
                              // + "\n Căng con mắt lên mà chọn cho đúng"
                              ...
                              // "Nâng Skill\nThêm 1 Cấp");
                              // } else if (player.gender == 1) {
                              // this.createOtherMenu(player, ConstNpc.HOC_SKILL_10_NM, "|8| Skill Gồng Cơ Đít
                              // Hít Cơ Mông\n\n"
                              // + "|7|Chú ý chọn dúng cấp độ cần học"
                              // + "\n Cố ý chọn sai bị trừ tiền ngu ráng chịu"
                              // + "\n Căng con mắt lên mà chọn cho đúng"
                              ...
                              // "Nâng Skill\nThêm 1 Cấp");
                              // } else {
                              // this.createOtherMenu(player, ConstNpc.HOC_SKILL_10_XD, "|8| Skill Gồng Cơ Đít
                              // Hít Cơ Mông\n\n"
                              ...
                              case 2: // skill 11
                                 ...
                                 return;
                              // if (player.gender == 0) {
                              // this.createOtherMenu(player, ConstNpc.HOC_SKILL_11_TD, "|8| Skill Super
                              // Kame\n\n"
                              // + "|7|Chú ý chọn dúng cấp độ cần học"
                              // + "\n Cố ý chọn sai bị trừ tiền ngu ráng chịu"
                              // + "\n Căng con mắt lên mà chọn cho đúng"
                              ...
                              // "Nâng Skill\nThêm 1 Cấp");
                              // } else if (player.gender == 1) {
                              // this.createOtherMenu(player, ConstNpc.HOC_SKILL_11_NM, "|8| Skill Ma Phong
                              // Ba\n\n"
                              // + "|7|Chú ý chọn dúng cấp độ cần học"
                              // + "\n Cố ý chọn sai bị trừ tiền ngu ráng chịu"
                              // + "\n Căng con mắt lên mà chọn cho đúng"
                              ...
                              // "Nâng Skill\nThêm 1 Cấp");
                              // } else {
                              // this.createOtherMenu(player, ConstNpc.HOC_SKILL_11_XD, "|8| Skill Liên Hoàn
                              // Chưởng\n\n"
                              // + "|7|Chú ý chọn dúng cấp độ cần học"
                              // + "\n Cố ý chọn sai bị trừ tiền ngu ráng chịu"
                              // + "\n Căng con mắt lên mà chọn cho đúng"
                        ...
                        if (this.mapId == 5 || this.mapId == 13) {
                           if (player.iDMark.isBaseMenu()) {
                              switch (select) {
                                 ...
                                 // case 2:
                                 // CombineServiceNew.gI().openTabCombine(player,
                                 // CombineServiceNew.TAY_SAO_PHA_LE);
                                 // break;
                                 // case 3:
                                 ...
                                 // case 4:
                                 // CombineServiceNew.gI().openTabCombine(player,
                                 // CombineServiceNew.LINH_HOA_TRANG_BI);
                                 // break;
                                 // case 5:
                                 ...
                                 case 0:
                                    ...
                                    if (Util.isTrue(60, 100)) {
                                       ...
                                       try { // send effect susscess
                                          ...
                                          msg.writer().writeByte(2);
                                          msg.writer()
                                                .writeByte(InventoryService.gI().getIndexBag(player, trangSachCu));
                     ...
                     if (canOpenNpc(player)) {
                        if (this.mapId == 45) {
                           ...
                           this.createOtherMenu(player, ConstNpc.BASE_MENU, "|8|ĐIỂM DANH HÀNG NGÀY NHẬN HỒNG NGỌC\n"
                                 ...
                                 + "Hôm nay điểm danh nhận: "
                                 + (player.chuyencan == 0 ? 10000 : (10000 + (player.chuyencan * 1000)))
                                 + " hồng ngọc\n"
                                 + "Quà chuyên cần 7 ngày lần này: " + ((player.checkquachuyencan + 1) * 50000)
                                 + " Hồng Ngọc("
                                 + (player.chuyencan >= lanTiepTheo ? " Có thể nhận)"
                                       : ("Thiếu " + (lanTiepTheo - player.chuyencan) + " ngày)"))
                              ...
                              switch (select) {
                                 case 0:
                                    if (player.chuyencan < lanTiepTheo) {
                                       Service.getInstance().sendThongBao(player,
                                             "Bạn cần điểm danh thêm " + (lanTiepTheo - player.chuyencan) + " ngày");
                                       return;
                                    }
                        ...
                        if (this.mapId == 48) {
                           if (player.iDMark.isBaseMenu()) {
                              switch (select) {
                                 ...
                                 // + at.getTime() / 60 + " phút."
                                 // : text + "\nKhi tặng đủ 999 bông hoa toàn bộ máy chủ được tăng 20% HP trong
                                 // 60 phút\n",
                                 // "Tặng 1\n Bông hoa", "Tặng\n10 Bông", "Tặng\n99 Bông",
                                 // "Đổi\nHộp quà");
                                 // break;
                        ...
                        if (this.mapId == 5) {
                           if (player.iDMark.isBaseMenu()) {
                              switch (select) {
                                 ...
                                 // case 1:
                                 // CombineServiceNew.gI().openTabCombine(player,
                                 // CombineServiceNew.NANG_SKH_THANH_TON);
                                 // break;
                                 // case 2:
            ...
            // if (this.mapId == 48) {
            // createOtherMenu(player, ConstNpc.BASE_MENU,
            // "|7|SHOP ĐỒ HỦY DIỆT\n|6| Mang đủ 5 món đồ Thần linh và đem 99 Thức ăn đến
            // cho ta. Ta sẽ bán đồ Hủy diệt cho ngươi",
            ...
            // ShopService.gI().openShopSpecial(player, this, ConstNpc.SHOP_BILL_HUY_DIET_0,
            // 0, -1);
            // } else {
            // createOtherMenu(player, ConstNpc.IGNORE_MENU, "Yêu cầu mặc 5 món Thần linh",
            // "Đóng");
            // }
            // } else {
            // createOtherMenu(player, ConstNpc.IGNORE_MENU, "Ngươi chưa đủ 99 thức ăn",
            // "Đóng");
            // }
            // break;
            // case 1:
            // if (player.setClothes.setDTL == 5) {
            // ShopService.gI().openShopSpecial(player, this, ConstNpc.SHOP_BILL_HUY_DIET_1,
            // 1, -1);
            // } else {
            // createOtherMenu(player, ConstNpc.IGNORE_MENU, "Yêu cầu mặc 5 món Thần linh",
            // "Đóng");
            ...
            // + at.getTime() / 60 + " phút."
            // : text + "\nKhi tặng đủ 999 bông toàn bộ máy chủ được tăng tăng 20% sức đánh
            // trong 60 phút\n",
            // "Tặng 1\n Bông hoa", "Tặng\n10 Bông",
            // "Tặng\n99 Bông", "Đổi\nHộp quà");
            // break;
                           ...
                           switch (select) {
                              case 0:
                                 ...
                                 if (ngavoi == null || ngavoi.quantity < 99
                                    ...
                                    Service.getInstance().sendThongBao(player,
                                          "Nhà người chưa có đủ x99 mỗi loại.. cook");
                                    return;
                                 }
                                 if (InventoryService.gI().getCountEmptyBag(player) == 0) {
                                    Service.getInstance().sendThongBao(player, "Túi đầy rồi thằng ngu");
                                    ...
                                    InventoryService.gI().sendItemBags(player);
                                    Service.getInstance().sendThongBao(player,
                                          "Mày đã nhận được " + hop10thang3.template.name);
                                 }
                                 break;
                              case 1:
                                 Item xuvang = null;
                                 ...
                                 if (xuvang == null || xuvang.quantity < 999
                                    ...
                                    Service.getInstance().sendThongBao(player,
                                          "Nhà người chưa có đủ x999 mỗi loại.. cook");
                                    return;
                                 }
                                 if (InventoryService.gI().getCountEmptyBag(player) == 0) {
                                    Service.getInstance().sendThongBao(player, "Túi đầy rồi thằng ngu");
                                    ...
                                    InventoryService.gI().sendItemBags(player);
                                    Service.getInstance().sendThongBao(player,
                                          "Mày đã nhận được " + hop10thang3vip.template.name);
                                 }
                                 break;
                           }
                        }
                              ...
                              case 2:
                                 ...
                                 if (InventoryService.gI().getCountEmptyBag(player) < 3) {
                                    ...
                                    if (player.tichluynap >= 50000 && player.tichluynap < 500000) {
                                       ...
                                       Service.getInstance().sendThongBao(player,
                                             "Mày đã nhận được " + HopQua10thang3.template.name);
                        ...
                        if (this.mapId == 154) {
                           if (player.iDMark.isBaseMenu()) {
                              switch (select) {
                                 ...
                                 //// CombineServiceNew.gI().openTabCombine(player,
                                 // CombineServiceNew.PHAN_RA_DO_TS);
                                 //// break;
                                 // case 3:
                                 // CombineServiceNew.gI().openTabCombine(player,
                                 // CombineServiceNew.NANG_CAP_SKH_TS);
                                 // break;
                              }
                           } else if (player.iDMark.getIndexMenu() == ConstNpc.MENU_START_COMBINE) {
                              switch (player.combineNew.typeCombine) {
                     ...
                     if (canOpenNpc(player)) {
                        if (this.mapId == 47 || this.mapId == 84) {
                           this.createOtherMenu(player, ConstNpc.BASE_MENU, "|8|LÀM NHIỆM VỤ HÀNG NGÀY\n"
                                 ...
                                 + "|2|Nv dễ: " + ConstTask.GOLD_EASY + "  Thỏi vàng"// và " + ConstTask.RUBY_EASY + "
                                                                                     // Hồng Ngọc mỗi nhiệm vụ\n"
                                 + "Nv trung bình: " + ConstTask.GOLD_NORMAL + "  Thỏi vàng"// và " +
                                                                                            // ConstTask.RUBY_NORMAL + "
                                                                                            // Hồng Ngọc mỗi nhiệm vụ\n"
                                 + "Nv khó: " + ConstTask.GOLD_HARD + "  Thỏi vàng"// và " + ConstTask.RUBY_HARD + "
                                                                                   // Hồng Ngọc mỗi nhiệm vụ\n"
                                 + "Nv siêu khó: " + ConstTask.GOLD_VERY_HARD + "  Thỏi vàng"// và " +
                                                                                             // ConstTask.RUBY_VERY_HARD
                                                                                             // + " Hồng Ngọc mỗi nhiệm
                                                                                             // vụ\n"
                                 + "Nv địa ngục: " + ConstTask.GOLD_HELL + "  Thỏi vàng"// và " + ConstTask.RUBY_HELL +
                                                                                        // " Hồng Ngọc mỗi nhiệm vụ\n"
                                    ...
                                    if (player.playerTask.sideTask.template != null) {
                                       ...
                                       this.createOtherMenu(player, ConstNpc.MENU_OPTION_LEVEL_SIDE_TASK,
                                             "|7|Tối đa " + ConstTask.MAX_SIDE_TASK + " nhiệm vụ mỗi ngày\n"
                                                   + "|2|Nv dễ: " + ConstTask.GOLD_EASY + "  Thỏi vàng"// và " +
                                                                                                       // ConstTask.RUBY_EASY
                                                                                                       // + " Hồng Ngọc
                                                                                                       // mỗi nhiệm
                                                                                                       // vụ\n"
                                                   + "Nv trung bình: " + ConstTask.GOLD_NORMAL + "  Thỏi vàng"// và " +
                                                                                                              ...
                                                                                                              // nhiệm
                                                                                                              // vụ\n"
                                                   + "Nv khó: " + ConstTask.GOLD_HARD + "  Thỏi vàng"// và " +
                                                                                                     // ConstTask.RUBY_HARD
                                                                                                     // + " Hồng Ngọc
                                                                                                     // mỗi nhiệm vụ\n"
                                                   + "Nv siêu khó: " + ConstTask.GOLD_VERY_HARD + "  Thỏi vàng"// và " +
                                                                                                               ...
                                                                                                               // nhiệm
                                                                                                               // vụ\n"
                                                   + "Nv địa ngục: " + ConstTask.GOLD_HELL + "  Thỏi vàng"// và " +
                                                                                                          // ConstTask.RUBY_HELL
                                                                                                          // + " Hồng
                                                                                                          // Ngọc mỗi
                                                                                                          // nhiệm vụ\n"
                           ...
                           switch (select) {
                              case 0:
                                 ...
                                 if (InventoryService.gI().getCountEmptyBag(player) == 0) {
                                    ...
                                    int[] ct = new int[] { 1251, 1252, 1253, 1625, 1627, 1641, 1642, 1643, 1631, 1620,
                                          1632, 1626,
                                          1411, 1410, 1409, 1416, 1600, 1624, 1628, 1412, 1638, 1629, 1686, 1214, 1384,
                                          1636, 1639,
                                    ...
                                    InventoryService.gI().sendItemBags(player);
                                    Service.getInstance().sendThongBaoOK(player,
                                          "Ngươi nhận được: " + caiTrang.template.name);
                                 }
                                 break;
                              case 1:
                                 if (thoiVang == null || thoiVang.quantity < GACHA_TV) {
                                 ...
                                 if (InventoryService.gI().getCountEmptyBag(player) == 0) {
                                    ...
                                    InventoryService.gI().sendItemBags(player);
                                    Service.getInstance().sendThongBaoOK(player,
                                          "Ngươi nhận được: " + linhThu.template.name);
                                 }
                                 break;
                              case 2:// random pet
                                 if (thoiVang == null || thoiVang.quantity < GACHA_TV) {
                                 ...
                                 if (InventoryService.gI().getCountEmptyBag(player) == 0) {
                                    ...
                                    short[] pet = { 1644, 1645, 1646, 1647, 1648, 2036, 1196, 1197, 1198, 1221, 1222,
                                          1223 };
                                    ...
                                    Service.getInstance().sendMoney(player);
                                    Service.getInstance().sendThongBaoOK(player,
                                          "Ngươi nhận được: " + petRandom.template.name);
                                 }
                                 break;
                              case 3:
                                 if (thoiVang == null || thoiVang.quantity < GACHA_TV) {
                                 ...
                                 if (InventoryService.gI().getCountEmptyBag(player) == 0) {
                                    ...
                                    Item thucuoiGold = ItemService.gI()
                                          .createNewItem((short) thucuoigold[randomThuCuoi]);
                                    ...
                                    InventoryService.gI().sendItemBags(player);
                                    Service.getInstance().sendThongBaoOK(player,
                                          "Ngươi nhận được: " + thucuoiGold.template.name);
                                 }
                                 break;
                           }
                           ...
                           switch (select) {
                              case 0:
                                 if (xubac == null || xubac.quantity < 10000) {
                                    Service.getInstance().sendThongBaoOK(player,
                                          "Không đủ tiền cần : " + GACHA_XU + " Xu bạc");
                                    return;
                                 }
                                 if (InventoryService.gI().getCountEmptyBag(player) == 0) {
                                    Service.getInstance().sendThongBaoOK(player, "Túi đầy vui lòng dọn dẹp");
                                    ...
                                    int[] ct = new int[] { 1251, 1252, 1253, 1625, 1627, 1641, 1642, 1643, 1631, 1620,
                                          1632, 1626,
                                          1628, 1412, 1638, 1629, 1686, 1214, 1384, 1636, 1639, 1634, 1635, 1319, 1618,
                                          1619
                                    };
                                    int randomCt = new Random().nextInt(ct.length);
                                    Item caiTrang = ItemService.gI().createNewItem((short) ct[randomCt]);
                              ...
                              case 1:
                                 if (xubac == null || xubac.quantity < 10000) {
                                    Service.getInstance().sendThongBaoOK(player,
                                          "Không đủ tiền cần : " + GACHA_XU + " " + xubac.getName());
                                    return;
                                 }
                                 if (InventoryService.gI().getCountEmptyBag(player) == 0) {
                                    Service.getInstance().sendThongBaoOK(player, "Túi đầy vui lòng dọn dẹp");
                              ...
                              case 3:
                                 ...
                                 if (InventoryService.gI().getCountEmptyBag(player) == 0) {
                                    ...
                                    Item thucuoiCoin = ItemService.gI()
                                          .createNewItem((short) thucuoiVip[randomThuCuoi]);
                                    ...
                                    InventoryService.gI().sendItemBags(player);
                                    Service.getInstance().sendThongBaoOK(player,
                                          "Ngươi nhận được: " + thucuoiCoin.template.name);
                                 }
                                 break;
                           }
                        }
         ...
         public void confirmMenu(Player player, int select) {
            switch (player.iDMark.getIndexMenu()) {
               ...
               case ConstNpc.TAIXIU:
                  ...
                  if (((TaiXiu.gI().lastTimeEnd - System.currentTimeMillis()) / 1000) > 0 && player.goldTai == 0
                        && player.goldXiu == 0 && TaiXiu.gI().baotri == false) {
                     switch (select) {
                        case 0:
                           NpcService.gI().createMenuConMeo(player, ConstNpc.TAIXIU, 11039,
                                 "\n|7|---NHÀ CÁI TÀI XỈU---\n\n|3|Kết quả kì trước:  " + TaiXiu.gI().x + " : "
                  ...
                  } else if (((TaiXiu.gI().lastTimeEnd - System.currentTimeMillis()) / 1000) > 0 && player.goldTai > 0
                        ...
                        case 0:
                           NpcService.gI().createMenuConMeo(player, ConstNpc.TAIXIU, 11039,
                                 "\n|7|---NHÀ CÁI TÀI XỈU---\n\n|3|Kết quả kì trước:  " + TaiXiu.gI().x + " : "
                                       ...
                                       + "\n\nTổng nhà XỈU: " + Util.format(TaiXiu.gI().goldXiu)
                                       + " Hồng ngọc\n\n|5|Thời gian còn lại: " + time + "\n\n|7|Bạn đã cược Tài : "
                                       + Util.format(player.goldTai) + " Hồng ngọc",
                                 "Cập nhập", "Đóng");
                           break;
                     }
                  } else if (((TaiXiu.gI().lastTimeEnd - System.currentTimeMillis()) / 1000) > 0 && player.goldXiu > 0
                        && TaiXiu.gI().baotri == false) {
                     switch (select) {
                        case 0:
                           NpcService.gI().createMenuConMeo(player, ConstNpc.TAIXIU, 11039,
                                 "\n|7|---NHÀ CÁI TÀI XỈU---\n\n|3|Kết quả kì trước:  " + TaiXiu.gI().x + " : "
                                       ...
                                       + "\n\nTổng nhà XỈU: " + Util.format(TaiXiu.gI().goldXiu)
                                       + " Hồng ngọc\n\n|5|Thời gian còn lại: " + time + "\n\n|7|Bạn đã cược Xỉu : "
                                       + Util.format(player.goldXiu) + " Hồng ngọc",
                                 "Cập nhập", "Đóng");
                           break;
                     }
                  } else if (((TaiXiu.gI().lastTimeEnd - System.currentTimeMillis()) / 1000) > 0 && player.goldTai > 0
                     ...
                     switch (select) {
                        ...
                        && player.goldTai == 0 && TaiXiu.gI().baotri == true) {
                     switch (select) {
                        case 0:
                           NpcService.gI().createMenuConMeo(player, ConstNpc.TAIXIU, 11039,
                                 "\n|7|---NHÀ CÁI TÀI XỈU---\n\n|3|Kết quả kì trước:  " + TaiXiu.gI().x + " : "
               ...
               // Service.getInstance().sendThongBao(player,
               // "Ban người chơi " + ((Player) PLAYERID_OBJECT.get(player.id)).name + " thành
               // công");
               // }
               // break;
               ...
               // nhatvi.location.x = player.location.x;
               // nhatvi.location.y = player.location.y;
               // Service.getInstance().sendThongBao(player, "|2|Triệu hồi thành công boss Nhất
               // Vĩ");
               // break;
               // case 1:
               ...
               // Service.getInstance().sendThongBao(player, "|2|Triệu hồi thành công boss Nhị
               // Vĩ");
               // break;
               // case 2:
               ...
               // Service.getInstance().sendThongBao(player, "|2|Triệu hồi thành công boss Tam
               // Vĩ");
               // break;
               // case 3:
               ...
               // Service.getInstance().sendThongBao(player, "|2|Triệu hồi thành công boss Tứ
               // Vĩ");
               // break;
               // case 4:
               ...
               // Service.getInstance().sendThongBao(player, "|2|Triệu hồi thành công boss Ngũ
               // Vĩ");
               // break;
               // case 5:
               ...
               // Service.getInstance().sendThongBao(player, "|2|Triệu hồi thành công boss Lục
               // Vĩ");
               // break;
               // case 6:
               ...
               // Service.getInstance().sendThongBao(player, "|2|Triệu hồi thành công boss Thất
               // Vĩ");
               // break;
               // case 7:
               ...
               // Service.getInstance().sendThongBao(player, "|2|Triệu hồi thành công boss Bát
               // Vĩ");
               // break;
               // case 8:
               ...
               // Service.getInstance().sendThongBao(player, "|2|Triệu hồi thành công boss Cửu
               // Vĩ");
               // break;
               // case 9:
               ...
               // Service.getInstance().sendThongBao(player, "|2|Triệu hồi thành công boss Thập
               // Vĩ");
               // break;
               //// }
               // break;
               ...
               case ConstNpc.CHON_HT_DE_MABU: {
                  ...
                  if (trungDt == null || trungDt.quantity < 1) {
                     Service.getInstance().sendThongBaoOK(player,
                           "Vật phẩm không tồn tại, hoặc có lỗi hiển thị vật phẩm\n"
                     ...
                     case 0:
                        NpcService.gI().createMenuConMeo(player, ConstNpc.INFO_ALL, 12713,
                              "|7|THÔNG TIN NHÂN VẬT"
                                    + "\b|5|HP bản thân: " + Util.format(player.nPoint.hp) + "/"
                                    + Util.powerToString(player.nPoint.hpMax)
                                    + "\bKI bản thân: " + Util.format(player.nPoint.mp) + "/"
                                    + Util.powerToString(player.nPoint.mpMax)
                     ...
                     case 1:
                        NpcService.gI().createMenuConMeo(player, ConstNpc.INFO_ALL, 12713,
                              "|7|THÔNG TIN ĐỆ TỬ"
                                    ...
                                    + "\bKI ĐỆ TỬ: " + Util.format(player.pet.nPoint.mp) + "/"
                                    + Util.powerToString(player.pet.nPoint.mpMax)
               ...
               case ConstNpc.MO_RONG_RUONG_SUU_TAM:
                  if (select == 0) {
                     ...
                     if (thoiVang != null && thoiVang.quantity >= RuongSuuTam.QUATITY) {
                        ...
                        Service.getInstance().sendThongBao(player,
                              "Mở thêm 1 ô " + RuongSuuTam.gI().nameRuong(player, player.typeMoRuong) + " Thành công");
                     } else {
               ...
               case ConstNpc.NANG_CAP_KHAM_NGOC:
                  if (select == 0) {
                     ...
                     if (item == null || item.quantity < max_quatity) {
                        Service.getInstance().sendThongBao(player, "Không đủ nguyên liệu. Còn thiếu "
               ...
               case ConstNpc.MO_RONG_PHONG_THI_NGHIEM:
                  if (select == 0) {
                     Item thoiVang = InventoryService.gI().findItemBagByTemp(player,
                           (short) PhongThiNghiem.ID_ITEM_MO_RONG);
                     ...
                     if (thoiVang != null && thoiVang.quantity >= PhongThiNghiem.SO_LUONG) {
                        ...
                        Service.getInstance().sendThongBao(player,
                              "Không đủ " + PhongThiNghiem.SO_LUONG + " Thỏi vàng");
                     }
                  }
                  break;
               case ConstNpc.HUY_PTN:
                  if (select == 0) {
                     ...
                     for (int i = 0; i < ptn.items.size(); i++) {
                        ...
                        text += "|5|-" + it.quantity + " " + it.template.name
                              + (i == (ptn.items.size() - 1) ? "" : "\n");
                        InventoryService.gI().addItemBag(player, it, 0);
                     }
                     InventoryService.gI().sendItemBags(player);
               ...
               case ConstNpc.TANG_TOC:
                  if (select == 0) {
                     Item item = InventoryService.gI().findItemBagByTemp(player,
                           (short) PhongThiNghiem.ID_ITEM_TANG_TOC);
                  ...
                  switch (select) {
                     case 0:
                        if (player.lastTimeTitle1 > 0) {
                           ...
                           Service.getInstance().point(player);
                           Service.getInstance().sendThongBao(player,
                                 "Đã " + (player.isTitleUse1 == true ? "Bật" : "Tắt") + " Danh Hiệu!");
                     ...
                     case 3:
                        if (player.lastTimeTitle4 > 0) {
                           ...
                           Service.getInstance().point(player);
                           Service.getInstance().sendThongBao(player,
                                 "Đã " + (player.isTitleUse4 == true ? "Bật" : "Tắt") + " Danh Hiệu!");
                           Service.getInstance().sendTitle(player, 892);
                           Service.getInstance().sendTitle(player, 891);
                           Service.getInstance().sendTitle(player, 890);
                           Service.getInstance().sendTitle(player, 889);
                     ...
                     case 4:
                        if (player.lastTimeTitle5 > 0) {
                           ...
                           Service.getInstance().point(player);
                           Service.getInstance().sendThongBao(player,
                                 "Đã " + (player.isTitleUse5 == true ? "Bật" : "Tắt") + " Danh Hiệu!");
                           Service.getInstance().sendTitle(player, 892);
                           Service.getInstance().sendTitle(player, 891);
                           Service.getInstance().sendTitle(player, 890);
                           Service.getInstance().sendTitle(player, 889);
